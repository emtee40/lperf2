...
/* Define to 1 if you have the declaration of `MSG_ZEROCOPY', and to 0 if you
   don't. */
#define HAVE_DECL_MSG_ZEROCOPY 1
...
/* Define if select based writes are desired */
#define HAVE_USE_WRITE_SELECT 1
...
#define PACKAGE_STRING "Iperf 2.1.n"
